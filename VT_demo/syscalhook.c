...
typedef ULONG64(__fastcall *NTUSERQUERYWINDOW)(IN HANDLE WindowHandle,
...
signed __int64 __fastcall MyNtWriteVirtualMemory(PHANDLE ProcessHandle,
                                                 __int64 a2,
                                                 unsigned __int64 AccessMode,
                                                 __int64 a4,
                                                 unsigned __int64 a5);
...
signed __int64 __fastcall MyNtReadVirtualMemory(PHANDLE ProcessHandle,
                                                unsigned __int64 AccessMode,
                                                __int64 a3, __int64 a4,
                                                unsigned __int64 a5);

NTSTATUS myNtSetInformationThread(HANDLE threadHandle,
...
VOID EnbaleHookSysCALL() { __writemsr(MSR_LSTAR, GuestSyscallHandler); }
VOID DisableHookSysCALL() { __writemsr(MSR_LSTAR, NtSyscallHandler); }
...
VOID initdata() {
  ...
  NtKernelsyscallBase =
      (ULONG64)__readmsr(MSR_LSTAR); // kisystemcall64 entry point
