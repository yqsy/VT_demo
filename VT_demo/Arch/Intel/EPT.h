...
/// <returns>Status code</returns>
NTSTATUS EptUpdateTableRecursive(IN struct _EPT_DATA *pEPTData,
                                 IN PEPT_MMPTE pTable, IN EPT_TABLE_LEVEL level,
                                 IN ULONG64 pfn, IN EPT_ACCESS access,
                                 IN ULONG64 hostPFN, IN ULONG count);
