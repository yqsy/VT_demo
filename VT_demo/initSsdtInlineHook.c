...
void InitIalzeSsdtInlineHook() {
  ...
  pslp_head_n_byte40 =
      HookKernelApi(NtCreateDebugObject, (PVOID)proxyNtCreateDebugObject,
                    &ori_pslp40, &pslp_patch_size40);

  pslp_head_n_byte41 =
      HookKernelApi(NtWaitForDebugEvent, (PVOID)proxyNtWaitForDebugEvent,
                    &ori_pslp41, &pslp_patch_size41);

  pslp_head_n_byte42 =
      HookKernelApi(NtDebugContinue, (PVOID)proxyNtDebugContinue, &ori_pslp42,
                    &pslp_patch_size42);

  pslp_head_n_byte43 =
      HookKernelApi(NtDebugActiveProcess, (PVOID)proxyNtDebugActiveProcess,
                    &ori_pslp43, &pslp_patch_size43);

  pslp_head_n_byte44 =
      HookKernelApi(myNtRemoveProcessDebug, (PVOID)NtRemoveProcessDebug,
                    &ori_pslp44, &pslp_patch_size44);
}
...
void unloadSsdtInlineHook() {
  ...
  UnhookKernelApi(myNtRemoveProcessDebug, pslp_head_n_byte44,
                  pslp_patch_size44);
}