...
VMP_IMPORT const VMP_WCHAR *VMP_API
VMProtectDecryptStringW(const VMP_WCHAR *value);
...
VMP_IMPORT int VMP_API
VMProtectGetSerialNumberData(VMProtectSerialNumberData *data, int size);
...
VMP_IMPORT int VMP_API VMProtectActivateLicense(const char *code, char *serial,
                                                int size);
VMP_IMPORT int VMP_API VMProtectDeactivateLicense(const char *serial);
VMP_IMPORT int VMP_API VMProtectGetOfflineActivationString(const char *code,
                                                           char *buf, int size);
VMP_IMPORT int VMP_API VMProtectGetOfflineDeactivationString(const char *serial,
                                                             char *buf,
                                                             int size);
