...
typedef enum SEGREGS { ES = 0, CS, SS, DS, FS, GS, LDTR, TR };
...
VOID _CpuId(ULONG32 fn, OUT PULONG32 ret_eax, OUT PULONG32 ret_ebx,
            OUT PULONG32 ret_ecx, OUT PULONG32 ret_edx);
