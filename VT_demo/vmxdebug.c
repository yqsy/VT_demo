...
VOID VmxDumpVmcs() {
  ...
  KdPrint(("VM_ENTRY_MSR_LOAD_ADDR 0x%X: 0x%llx\n", VM_ENTRY_MSR_LOAD_ADDR,
           VmxRead(VM_ENTRY_MSR_LOAD_ADDR)));
  ...
  KdPrint(("TSC_OFFSET_HIGH 0x%X: 0x%llx\n", TSC_OFFSET_HIGH,
           VmxRead(TSC_OFFSET_HIGH)));
  //
  KdPrint(("VIRTUAL_APIC_PAGE_ADDR 0x%X: 0x%llx\n", VIRTUAL_APIC_PAGE_ADDR,
           VmxRead(VIRTUAL_APIC_PAGE_ADDR)));
  ...
  KdPrint(
      ("VM_ENTRY_EXCEPTION_ERROR_CODE 0x%X: 0x%llx\n", addr, VmxRead(addr)));
